...
data <- read_excel("C:\\Users\\Fitria Angelita D\\Downloads\\NSC-2025.xlsx", sheet="Sheet2")
...
Didapatkan nilai $\hat\beta_0 = 84.2552$ artinya nilai dugaan rataan indeks pembangunan manusia ketika rata-rata lama sekolah bernilai 0 persen adalah 84.255%, akan tetapi nilai 0 tidak ada dalam selang pengamatan rata-rata lama sekolah sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_0 = -0.9377205$ artinya nilai dugaan perubahan dugaan rataan Indeks Pembangunan Manusia jika Rata-rata lama sekolah berubah satu tahun adalah sebesar -0.938%

Koefisien determinasi yang dihasilkan adalah 0.48314 atau 48.31% artinya keragaman persentase penduduk miskin yang dapat dijelaskan oleh persentase akses sanitasi layak adalah sebesar 48.31%, sisanya yaitu 51.69% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
